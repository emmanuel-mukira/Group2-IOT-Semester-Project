...
This remapping gives our group a clean pin layout that is different from the other group's working prototype while still using sensible ESP32 pins.
...
|---|---:|---:|---|
| OLED display | SDA | GPIO18 | New I2C data pin, avoids copying GPIO21 |
| OLED display | SCL | GPIO19 | New I2C clock pin, avoids copying GPIO22 |
...
- GPIO34 and GPIO35 also work for analog input, but leaving them behind makes our final mapping visibly different.
